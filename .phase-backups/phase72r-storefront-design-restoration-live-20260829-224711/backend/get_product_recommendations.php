...
try {
    ...
    echo json_encode(array_merge(['success' => true, 'module' => 'product-recommendations-public-feed'], productRecommendationsPublicState($pdo)), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
} catch (Throwable $error) {
    error_log('get_product_recommendations.php: ' . $error->getMessage());
    http_response_code(500);
    echo json_encode(['success' => false, 'module' => 'product-recommendations-public-feed', 'message' => 'Public recommendations are temporarily unavailable.']);
}
