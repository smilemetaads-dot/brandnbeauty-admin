...
const REFERENCE_EDITOR_SECTIONS = [
  { id: "basic", label: "General", helper: "Identity & description" },
  { id: "images", label: "Media", helper: "Images & alt text" },
  { id: "pricing", label: "Pricing", helper: "Price, cost & margin" },
  { id: "inventory", label: "Inventory", helper: "SKU & stock policy" },
  { id: "organization", label: "Organization", helper: "Category & merchandising" },
  { id: "content", label: "Product content", helper: "Benefits & ingredients" },
  { id: "variants", label: "Variants", helper: "Options & combinations" },
  { id: "seo", label: "SEO & shipping", helper: "Search & fulfilment" },
];
  ...
  return (
    <ProductEditorFrame embedded={_props.embedded}>
      ...
      <section className="flex flex-col gap-5 border-b border-slate-200 pb-6 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <button className="text-sm font-semibold text-[#5E7F85] transition hover:text-slate-950" onClick={goBackToProducts} type="button">← Back to products</button>
      ...
      <div className="grid gap-6 xl:grid-cols-[240px_minmax(0,1fr)_310px]">
        ...
        <div className="min-w-0 space-y-6">
          <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="text-xs font-bold uppercase tracking-[0.16em] text-[#5E7F85]">Reference product editor</div>
        ...
        <div className="space-y-6">
          <div style={{ display: ["basic", "organization"].includes(activeEditorSection) ? undefined : "none" }} className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm"><div className="flex items-center justify-between gap-3"><h2 className="text-xl font-bold tracking-tight">{activeEditorSection === "organization" ? "Organization" : "General information"}</h2></div>
