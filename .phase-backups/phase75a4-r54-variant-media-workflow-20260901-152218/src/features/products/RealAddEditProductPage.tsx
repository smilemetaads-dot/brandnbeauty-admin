...
// Phase 75A.4 R5.3: world-class single/variant product architecture lock.
/* eslint-disable */
/*
...
export function RealAddEditProductPage(_props: RealAddEditProductPageProps) {
  ...
  const skuConflict = otherCatalogRows.some(
    (item) => String(item.sku || "").trim().toLowerCase() === autoSku.toLowerCase(),
  );
        ...
        >
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            {renderExactUploadSlot({
              ...
              helper: "Optional supporting image",
          ...
          {galleryImages.length > 3 ? (
            <div className="rounded-xl bg-[#f6f8f7] px-3 py-2 text-[7px] text-[#74837b]">
              {galleryImages.length - 3} additional gallery image(s) are saved.
            </div>
          ) : null}
          {isVariantProduct ? (
        ...
        >
          ...
          {!isVariantProduct ? (
            ...
            <div className="space-y-4">
              <div className="rounded-xl border border-[#dce5e2] bg-[#f8faf9] p-4">
                ...
                <div className="mt-4 space-y-3">
                  {variantOptionGroups.map((group, index) => (
                    <div
                      className="grid gap-3 rounded-xl border border-[#e1e7e4] bg-white p-3 sm:grid-cols-[.8fr_1.5fr_auto]"
                      key={group.id}
                    >
                      <label className={exactLabelClass}>
                        Option type
                      ...
                      <label className={exactLabelClass}>
                        ...
                        <input
                          ...
                          key={`${group.id}-${group.values.join("|")}`}
                          onBlur={(event) =>
                            updateVariantOptionGroup(
                              index,
                              "values",
              ...
              {variants.length ? (
                <div className="overflow-x-auto rounded-xl border border-[#e1e7e4]">
                  <div className="min-w-[980px]">
                    <div className="grid grid-cols-[1.25fr_1.2fr_.72fr_.72fr_.72fr_.52fr_.9fr_.42fr_.5fr_.28fr] gap-2 bg-[#f6f8f7] px-3 py-2 text-[6.5px] font-bold uppercase tracking-[0.08em] text-[#85918b]">
                    ...
                    {variants.map((variant, index) => (
                      <div
                        className="grid grid-cols-[1.25fr_1.2fr_.72fr_.72fr_.72fr_.52fr_.9fr_.42fr_.5fr_.28fr] items-center gap-2 border-t border-[#edf0ee] px-3 py-3"
                        key={variant.id || index}
                      >
                        <div className="min-w-0">
                          <div className="truncate text-[8px] font-bold text-[#40534b]">
                            {variant.option}
                          </div>
                          <div className="mt-1 truncate text-[6.5px] text-[#8a9690]">
                            {variant.optionName}
                          </div>
                        </div>
                        <input
                          className="h-9 min-w-0 rounded-lg border border-[#dce4e0] px-2 text-[7.5px] font-semibold uppercase outline-none"
                          onChange={(event) =>
                            updateVariantField(
                              index,
                              "sku",
                        ...
                        {[
                          ...
                          <input
                            className="h-9 min-w-0 rounded-lg border border-[#dce4e0] px-2 text-[7.5px] outline-none"
                            key={field}
                            min="0"
                            onChange={(event) =>
                        ...
                        <span className="text-center text-[8px] font-bold text-[#506159]">
                        ...
                        <div className="flex items-center gap-2">
                          <label className="cursor-pointer">
                            ...
                            />
                            <span
                              className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#dce4e0] bg-white bg-contain bg-center bg-no-repeat text-[11px] font-bold text-[#5f8585]"
                              style={
                              ...
                              title="Upload dedicated variant image"
                            >
                              {variant.imageUrl || imageUrl ? "" : "+"}
                            </span>
                          </label>
                          <div className="min-w-0">
                            <div className="text-[6.5px] font-bold text-[#60746b]">
                              {variant.imageUrl ? "Own" : "Inherited"}
                            </div>
                            {variant.imageUrl ? (
                              <button
                                className="text-[6.5px] font-bold text-rose-600"
                                onClick={() => updateVariantField(index, "imageUrl", "")}
                                type="button"
                              >
                                Clear
                              </button>
                        ...
                        <button
                          aria-label={`Toggle ${variant.option || `variant ${index + 1}`}`}
                          aria-pressed={variant.status === "Active"}
                          className={`mx-auto h-5 w-9 rounded-full text-[0px] ${variant.status === "Active" ? "bg-[#5f8585]" : "bg-[#dce4e0]"}`}
                          onClick={() =>
                            updateVariantField(
                              index,
                              "status",
                        ...
                        <label className="mx-auto flex cursor-pointer items-center gap-1 text-[7px] font-semibold text-[#60746b]">
                          <input
                        ...
                        <button
                          aria-label={`Remove ${variant.option || `variant ${index + 1}`}`}
                          className="mx-auto flex h-8 w-8 items-center justify-center rounded-lg text-[12px] font-bold text-rose-700 disabled:opacity-30"
                    ...
                    <div className="flex items-center justify-between border-t border-[#edf0ee] bg-[#fbfcfb] px-3 py-3">
                      ...
                      <span className="text-[7px] font-semibold text-[#5f8585]">
                        Price, cost and image are controlled per row
                      </span>
                    </div>
                  </div>
                </div>
          ...
          {isVariantProduct ? (
            <div className="rounded-xl border border-[#cfe0dc] bg-[#eef6f4] px-4 py-3 text-[7px] leading-4 text-[#55736d]">
              Variant image rule: a dedicated image appears when that option is
              selected on the storefront. If empty, the primary product image
