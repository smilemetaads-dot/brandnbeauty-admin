    ...
    <AdminShell>
      <div className="space-y-6">
        ...
        <section className="flex flex-col gap-4 rounded-[2rem] border border-slate-200 bg-white px-6 py-5 shadow-sm xl:flex-row xl:items-center xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
              Search, review, and manage the products available across the BrandnBeauty storefront.
            </p>
          </div>
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          />
          <AdminStatCard
            helper="Stocked items at 10 or below"
            icon="LS"
            index={1}
            label="Low Stock"
            value={lowStockCount}
          ...
          />
          <AdminStatCard
            helper="Current price x physical stock"
            icon="BDT"
            index={3}
            label="Catalog Value"
