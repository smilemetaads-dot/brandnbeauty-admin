// REFERENCE ONLY.
// Original Canvas Invoice & Thank You Settings design source.
// Do not import this file into production src.
// Use only as visual skeleton reference for rebuilding the live Invoice & Thank You Settings page.
...
export default function OrderSettingsPlaceholderPage() {
  const page = "Invoice & Thank You Settings";
  const features = [
    "Order ID format",
    "Thank you message",
    "Invoice PDF button",
