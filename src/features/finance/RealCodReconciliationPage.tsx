...
export function RealCodReconciliationPage() {
  ...
  return <AdminShell><div className="space-y-6">
    <section className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm"><p className="text-xs font-bold uppercase tracking-[0.16em] text-[#5E7F85]">Finance Control</p><div className="mt-2 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between"><div><h1 className="text-2xl font-bold tracking-tight text-slate-950">COD Reconciliation</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">Legacy read-only view. Use Finance → Reconciliation for all settlement evidence and deductions.</p></div><button className="rounded-2xl border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-700" onClick={() => void load()} type="button">Refresh</button></div></section>
