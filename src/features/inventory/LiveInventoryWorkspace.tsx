...
const emptySummary: InventorySummary = { availableUnits: 0, damagedUnits: 0, draftAdjustments: 0, inStock: 0, incomingUnits: 0, lowStock: 0, onHandUnits: 0, outOfStock: 0, quarantineUnits: 0, reservedUnits: 0, totalSkus: 0 };
