...
function renderAccess(enabled: boolean) {
  return (
    <span
...
export default function RealBannerCmsPage() {
  return (
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold">Admin Role & Permission Matrix</h1>
                    ...
                    {roles.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {renderAccess(item.products)}
                        </td>
                        <td className="px-4 py-3">
                          {renderAccess(item.customers)}
                        </td>
                        <td className="px-4 py-3">
                          {renderAccess(item.finance)}
                        </td>
                        <td className="px-4 py-3">
                          {renderAccess(item.settings)}
                        </td>
                        <td className="px-4 py-3">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 space-y-3 text-sm text-slate-600">
                ...
                <div className="rounded-2xl bg-stone-50 p-4">
                  Operations team should not edit courier API credentials
                  directly.
                </div>
                <div className="rounded-2xl bg-amber-50 p-4 text-amber-800">
                  Every permission change should be logged with who changed it
                  and when.
                </div>
              </div>
            </div>
